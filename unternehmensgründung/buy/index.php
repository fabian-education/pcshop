    ...
    <a href="/"><img src="../images/logo.png"></a>
        <nav>
            <ul class="list_right">
                ...
                <li class="headbar" type="button" onclick="home()">Home</li>
                <li class="headbar" type="button" onclick="pc_builder()">PC Builder</li>
                <li class="headbar" type="button" onclick="about_us()">About us</li>
            </ul>
        </nav>
        ...
        <form id="purchase_form" action="../backend/new_order.php" method="post">
            ...
            <div id="page2">
                ...
                <div id="qrcode"></div>
                <h3 id="info_label" class="label" value="" onclick="copy_to_clipboard(this.id)" >Address: ... | Amount: ...</h3>
                <h2 id="status_label" class="label" style="white-space: pre-line">Status: Waiting for Transaction</h2>
                <input type="button" value="Refresh" class="buy" id="refresh_button" onclick="refresh_transactions(false)">
